...
public final class StudentAnalytics {
    ...
    private static Predicate<Student> olderThan20        = s ->  s.getAge()   > 20;
    private static Predicate<Student> gradeBelow65       = s ->  s.getGrade() < 65;
    private static Predicate<Student> currentlyNotActive = s -> !s.checkIsCurrent();
    private static Predicate<Student> failedStudConditions = olderThan20.and(gradeBelow65).and(currentlyNotActive);
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
        ...
        Optional<Entry<String,Long>> optResutl = Stream.of(studentArray)
                                                    .parallel()
        ...
        if(optResutl.isPresent())
            result = optResutl.get().getKey();
    ...
    public int countNumberOfFailedStudentsOlderThan20ParallelStream(
        ...
        int result = (int)Stream.of(studentArray)
                .parallel()
                .filter(failedStudConditions).count();
